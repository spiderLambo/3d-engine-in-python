...
class Object3d:
    ...
    def screen_projection(self):
        ...
        vertexes = vertexes @ self.render.projection_matrix
        ...
        for vertexe in vertexes:
            if not np.any(
                (vertexe == self.render.H_WIDTH) | (vertexe == self.render.H_HEIGHT)
            ):
                pg.draw.circle(self.render.screen, pg.Color("white"), vertexe, 6)
